...
URL = 'rtsp://admin:admin@192.168.1.78/live1.sdp' 
#URL = 0
...
while True:
    ...
    density_cut1 = frame[0:540,0:1920] 
    density_cut2 = frame[0:540,0:1920] 
    density_cut1 = cv2.cvtColor(density_cut1, cv2.COLOR_BGR2GRAY)
    density = image.img_to_array(density_cut1)
    cv2.imshow('Objecst detector', density)
    cv2.waitKey(1)
    ...
    cv2.putText(frame, text, (5, 30), cv2.FONT_HERSHEY_PLAIN, 2.0, (0, 0, 255), 2) 
